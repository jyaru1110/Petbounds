function regUsuario() {
    ...
    if (cont === 3) {
        ...
        var enlace = 'https://petlimits.xyz/api/formUsuario?correo=' + correo + '&contra=' + contras + '&nom=' + nombreCom + '&pat=null' + '&mat=null' + '&nick=' + nick + '&nac=' + fecha + '&gen=' + gen;
        $.ajax({
            type: 'POST',
            url: enlace,
            success: response => {
...
function regOrg() {
    ...
    if (cont === 3) {
        ...
        var enlace = 'https://petlimits.xyz/api/formOrg?correo=' + correo + '&contra=' + contras + '&nom=' + org + '&tel=' + tele + '&pag=' + pag;
        $.ajax({
            type: 'POST',
            url: enlace,
            success: response => {
...
function regNeg() {
    ...
    if (cont === 3) {
        ...
        var enlace = 'https://petlimits.xyz/api/formNeg?correo=' + correo + '&contra=' + contras + '&nom=' + neg + '&tel=' + tele + '&ubi=' + ubi;
        $.ajax({
            type: 'POST',
            url: enlace,
            success: response => {
...
function regMas() {
    ...
    if (/[a-zA-z]/.test(nombre) && /[a-zA-z]/.test(raza)) {
        var enlace = 'https://petlimits.xyz/api/altaMas?id=' + id + '&tipo=' + tipo + '&raza=' + raza + '&edad=' + edad + '&hist=' + desc + '&nom=' + nombre + '&foto=' + foto;
        $.ajax({
            type: 'POST',
            url: enlace,
            success: response => {
...
function regSol(){
    ...
    var enlace = 'https://petlimits.xyz/api/regSolicitud?usu=' + id + '&mas=' + idSel + '&identi=' + idOf + '&comp=' + comp_dom + '&pago=' + comp_pago;
    $.ajax({
        type: 'POST',
        url: enlace,
        success: response => {
...
function modMas(){
    ...
    console.log(foto);
    var enlace = 'https://petlimits.xyz/api/modMas?id=' + id + '&tipo=' + tipo + '&raz=' + raza + '&edad=' + edad + '&hist=' + hist + '&nom=' + nom + '&foto=' + foto;
    $.ajax({
        type: 'PUT',
        url: enlace,
        success: response => {
