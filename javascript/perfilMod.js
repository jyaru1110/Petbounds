function selecUsu() {
    ...
    var enlace = 'https://petlimits.xyz/api/mostrarUsu?correo=' + correo;
    $.ajax({
        type: 'GET',
        url: enlace,
        success: response => {
...
function modUsu() {
    ...
    var url = Cookies.get('foto');
    var enlace = 'https://petlimits.xyz/api/modUsu?id=' + id + '&nom=' + nombre + '&pat=null&mat=null&nick=' + nick + '&nac=' + nacimiento + '&foto=' + url;
    $.ajax({
        type: 'PUT',
        url: enlace,
        success: response => {
...
function borrarUsu() {
    var correo = Cookies.get('correo');
    var enlace = 'https://petlimits.xyz/api/borrarUsu?correo=' + correo;
    $.ajax({
        type: 'DELETE',
        url: enlace,
        success: response => {
